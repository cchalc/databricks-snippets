...
# MAGIC %md
# MAGIC - Reference: http://nadbordrozd.github.io/blog/2016/05/22/one-weird-trick-that-will-fix-your-pyspark-schemas/
# MAGIC - plan is to fix reading schemas
...
result = df_from_rdd(rdd, diamonds, sqlContext)
